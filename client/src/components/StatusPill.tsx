type StatusPillProps = {
  status: "verified" | "pending" | "active" | "paused" | "empty";
  compact?: boolean;
};

const statusStyles = {
  verified: { label: "Terverifikasi", className: "bg-emerald-50 text-emerald-800 ring-emerald-700/15", dot: "bg-emerald-500" },
