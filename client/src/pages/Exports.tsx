...
import { buildExportZipUrl, getExportDateRangeError } from "@/lib/exportUrl";
...
export default function Exports() {
  ...
  const dateRangeError = useMemo(() => getExportDateRangeError({ cameraId, fromDate, toDate }), [cameraId, fromDate, toDate]);
  ...
  const canBuild = snapshots.length > 0 && !snapshotQuery.isLoading && !snapshotQuery.isError && !dateRangeError;
  const startExport = () => {
    if (isGuest) return;
